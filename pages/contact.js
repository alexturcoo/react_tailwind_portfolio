    ...
    return(
        <div className=" flex bg-gray-800 h-screen">
            ...
            <hr className="my-4 mx-auto w-48 h-1 bg-gray-100 rounded border-0 md:my-10 dark:bg-gray-700" />
                ...
                <label className=" font-mono bg-gradient-to-r from-cyan-500 text- to-teal-500 text-black p-2 border-none rounded ">School Email: alexander.turco@mail.utoronto.ca</label>
                </ul>
                <ul className="py-5 text-center">
